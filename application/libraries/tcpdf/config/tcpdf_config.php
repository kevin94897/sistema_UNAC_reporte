 ...
 */
define ('K_BLANK_IMAGE', '__blank.png');
 ...
 * Document author.
 */
define ('PDF_AUTHOR', 'Kevin');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Sistema Intranet Bibliotecario FIIS');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "por Grupo FIIS - Curso Ingenieria de Sistemas");
